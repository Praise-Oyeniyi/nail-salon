...
const Banner = () => {
  ...
  if (!bannerData) {
    return (
      <div
        className="bg-gray-100 md:bg-[#fff1f5] md:pl-10 md:pr-0 px-5 w-full 
      py-24 max-md:animate-pulse md:py-0 md:h-[50vh] overflow-hidden relative"
      >
        <div
          className="max-md:hidden flex justify-between 
        items-end gap-x-10 h-full animate-pulse"
        >
          {/* Text Section Skeleton */}
          <div
            className="self-center md:w-3/6 z-20 
  ...
  return (
    ...
    >
      <div className="flex justify-between items-end gap-x-10 h-full">
        {/* Text Section */}
        <div
          className="self-center w-3/6 z-20 text-center md:text-left lg:pl-7
        ...
        >
          {slides.map((slide, index) => (
            ...
            >
              <h2
                className="text-3xl md:text-5xl tracking-wide font-semibold
               leading-tighter md:pl-5 lg:pl-8 z-20"
              >
                {slide.description}
              </h2>
              <button
        ...
        {/* Image Section */}
        <div
          className="h-full w-full md:w-1/2 banner-inner md:relative lg:after:absolute   
