...
const CartItem = ({image, count, name, price, info, color, size, id, cartId}) => {
      ...
      <div className='md:py-3 py-2'>
        <div className='flex items-center gap-x-3 md:gap-x-5 relative'>
          ...
          <div className='md:space-y-1 relative'>
            ...
            <p className='cursor-pointer my-1 md:my-0 color w-fit text-sm  px-2 rounded-xl shadow-sm shadow-gray-400'>{size}</p>
            </div>
