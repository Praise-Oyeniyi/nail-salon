    ...
    <div className='w-full'>
        <div className='w-full border border-gray-200 rounded-md'>
            <div className='w-full md:px-5 p-1 md:py-3 py-2'>
                ...
                <h5 className="state  ml-2 font-medium w-fit text-[#ff00ff] md:tracking-wider px-1 text-xs md:text-sm bg-[#fff1f5]">Unfufilled</h5>
                    ...
                    <div className="order-item-in w-full ">
                        <div className='flex w-full justify-between'>
                            <div className="left flex gap-x-2">
                                ...
                                <div className='text-sm'>
                                    ...
                                    <div className="colors gap-x-1 text-xs flex font-medium">
                                        ...
                                        <button className='border border-[#cccccc] px-2 max-w-fit'>Black</button>
                            ...
                            <div className="right self-end flex items-center justify-center gap-x-1 md:gap-x-3 text-xs md:text-sm">
                                <button className='amount border border-gray-700 w-16 md:w-20 rounded-md text-center font-medium'>{'10'} piece</button>
                                <p className='cost border border-gray-600 w-12 md:w-16 rounded-md text-center font-medium'>$300</p>
                            </div>
                        </div>
                    </div>
                </div>
