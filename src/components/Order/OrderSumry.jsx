    ...
    <div className='space-y-3'>
        <div className='border border-gray-200 rounded-md text-summary'>
            <div className='py-3 space-y-2'>
                <div className='md:px-5 px-1'>
                    ...
                    <h5 className="state ml-2 font-medium w-fit text-[#ff00ff] md:tracking-wider px-1 text-xs md:text-sm bg-[#fff1f5]">Payment Pending</h5>
        ...
        <div className="timeline border-2 border-gray-300 rounded-md md:px-5 px-3 md:py-3 py-2">
            <div className='text-sm'>
                ...
                <h6 className='name border border-gray-300 rounded-md px-2 w-fit my-1 font-bold text-sm md:text-base'>Timmy Witty</h6>
